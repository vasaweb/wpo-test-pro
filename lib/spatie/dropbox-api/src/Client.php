...
use Exception;
use WPO\WC\PDF_Invoices_Pro\Vendor\GrahamCampbell\GuzzleFactory\GuzzleFactory;
use WPO\WC\PDF_Invoices_Pro\Vendor\GuzzleHttp\Client as GuzzleClient;
use WPO\WC\PDF_Invoices_Pro\Vendor\GuzzleHttp\ClientInterface;
...
use WPO\WC\PDF_Invoices_Pro\Vendor\GuzzleHttp\Psr7\PumpStream;
use WPO\WC\PDF_Invoices_Pro\Vendor\GuzzleHttp\Psr7\StreamWrapper;
...
use WPO\WC\PDF_Invoices_Pro\Vendor\Spatie\Dropbox\Exceptions\BadRequest;
...
class Client
{
     ...
     * @param int $chunkSize
     * @param \WPO\WC\PDF_Invoices_Pro\Vendor\Spatie\Dropbox\UploadSessionCursor|null $cursor
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Spatie\Dropbox\UploadSessionCursor
     * @throws Exception
     */
     ...
     *
     * @param string|resource|StreamInterface $contents
     * @param \WPO\WC\PDF_Invoices_Pro\Vendor\Spatie\Dropbox\UploadSessionCursor $cursor
     * @param string $path
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Psr\Http\Message\ResponseInterface
     *
     * @throws \Exception
     */
     ...
     * @param $contents
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\GuzzleHttp\Psr7\PumpStream|\WPO\WC\PDF_Invoices_Pro\Vendor\GuzzleHttp\Psr7\Stream|StreamInterface
     */
