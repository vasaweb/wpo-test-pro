...
//               common 1D barcodes to be used with WPO_WCPDF_IPS_PRO_TCPDF.
//
//============================================================+

/**
 * @file
 * PHP class to creates array representations for common 1D barcodes to be used with WPO_WCPDF_IPS_PRO_TCPDF.
...
/**
 * @class WPO_WCPDF_IPS_PRO_TCPDFBarcode
 * PHP class to creates array representations for common 1D barcodes to be used with WPO_WCPDF_IPS_PRO_TCPDF (http://www.tcpdf.org).<br>
 * @package com.tecnick.tcpdf
 * @version 1.0.027
 * @author Nicola Asuni
 */
