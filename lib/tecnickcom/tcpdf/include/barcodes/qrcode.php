...
// DESCRIPTION :
//
// Class to create QR-code arrays for WPO_WCPDF_IPS_PRO_TCPDF class.
...
if (!defined('QRCODEDEFS')) {
	...
	// Encoding modes (characters which can be encoded in WPO_WCPDF_IPS_PRO_QRcode)
	...
	/**
	 * Encoding mode numeric (0-9). 3 characters are encoded to 10bit length. In theory, 7089 characters or less can be stored in a WPO_WCPDF_IPS_PRO_QRcode.
	 */
	define('QR_MODE_NM', 0);

	/**
	 * Encoding mode alphanumeric (0-9A-Z $%*+-./:) 45characters. 2 characters are encoded to 11bit length. In theory, 4296 characters or less can be stored in a WPO_WCPDF_IPS_PRO_QRcode.
	 */
	define('QR_MODE_AN', 1);

	/**
	 * Encoding mode 8bit byte data. In theory, 2953 characters or less can be stored in a WPO_WCPDF_IPS_PRO_QRcode.
	 */
	define('QR_MODE_8B', 2);

	/**
	 * Encoding mode KANJI. A KANJI character (multibyte character) is encoded to 13bit length. In theory, 1817 characters or less can be stored in a WPO_WCPDF_IPS_PRO_QRcode.
	 */
	define('QR_MODE_KJ', 3);
	...
	// WPO_WCPDF_IPS_PRO_QRcode has a function of an error correcting for miss reading that white is black.
	...
	// Version. Size of WPO_WCPDF_IPS_PRO_QRcode is defined as version.
...
/**
 * @class WPO_WCPDF_IPS_PRO_QRcode
 * Class to create QR-code arrays for WPO_WCPDF_IPS_PRO_TCPDF class.
 * QR Code symbol is a 2D barcode that can be scanned by handy terminals such as a mobile phone with CCD.
 * The capacity of QR Code is up to 7000 digits or 4000 characters, and has high robustness.
 * This class supports QR Code model 2, described in JIS (Japanese Industrial Standards) X0510:2004 or ISO/IEC 18004.
...
class WPO_WCPDF_IPS_PRO_QRcode {
	...
	/**
	 * Barcode array to be returned which is readable by WPO_WCPDF_IPS_PRO_TCPDF.
	 * @protected
	 */
	protected $barcode_array = array();

	/**
	 * QR code version. Size of WPO_WCPDF_IPS_PRO_QRcode is defined as version. Version is from 1 to 40. Version 1 is 21*21 matrix. And 4 modules increases whenever 1 version increases. So version 40 is 177*177 matrix.
	 * @protected
	 */
	protected $version = 0;
	 ...
	 * Creates a WPO_WCPDF_IPS_PRO_QRcode object
	 * @param string $code code to represent using WPO_WCPDF_IPS_PRO_QRcode
	...
	/**
	 * Returns a barcode array which is readable by WPO_WCPDF_IPS_PRO_TCPDF
	 * @return array barcode array readable by WPO_WCPDF_IPS_PRO_TCPDF;
	 * @public
	 */
...
} // end WPO_WCPDF_IPS_PRO_QRcode class
