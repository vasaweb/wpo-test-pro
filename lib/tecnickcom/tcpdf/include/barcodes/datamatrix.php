...
// DESCRIPTION :
//
// Class to create DataMatrix ECC 200 barcode arrays for WPO_WCPDF_IPS_PRO_TCPDF class.
...
/**
* @class WPO_WCPDF_IPS_PRO_Datamatrix
* Class to create DataMatrix ECC 200 barcode arrays for WPO_WCPDF_IPS_PRO_TCPDF class.
* DataMatrix (ISO/IEC 16022:2006) is a 2-dimensional bar code.
*
* @package com.tecnick.tcpdf
...
// -----------------------------------------------------------------------------
	 ...
	 * @param string $code Code to represent using WPO_WCPDF_IPS_PRO_Datamatrix.
	 * @public
	 */
