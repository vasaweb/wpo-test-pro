...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt;
...
abstract class Base
{
    /**#@+
     * @access public
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Base::encrypt()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Base::decrypt()
     */
    /**
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
    ...
    /**#@+
     * @access private
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Base::__construct()
     */
    /**
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Twofish::setKey()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
