 ...
 *
 * $private = \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC::createKey('secp256k1');
...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\Curve25519;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\Ed448;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Parameters;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\PrivateKey;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\PublicKey;
...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\UnsupportedOperationException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\ASN1;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\\' . $curveName;
