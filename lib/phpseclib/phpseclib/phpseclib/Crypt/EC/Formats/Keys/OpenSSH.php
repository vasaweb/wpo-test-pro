...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH as Progenitor;
...
abstract class OpenSSH extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if ($parsed['type'] == 'ssh-ed25519') {
            ...
            $curveName = '\WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\\' . $curveName;
            $curve = new $curveName();
