...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\BadConfigurationException;
...
abstract class XML
{
    ...
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\\' . $name;
