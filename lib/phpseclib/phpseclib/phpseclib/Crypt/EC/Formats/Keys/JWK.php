...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Formats\Keys;

use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Common\Functions\Strings;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\secp256k1;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\secp256r1;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\secp384r1;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     * @param \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
