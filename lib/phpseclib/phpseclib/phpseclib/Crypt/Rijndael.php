 ...
 *
 *    $rijndael = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Rijndael('ctr');
 *
...
class Rijndael extends BlockCipher
{
     ...
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::engine
