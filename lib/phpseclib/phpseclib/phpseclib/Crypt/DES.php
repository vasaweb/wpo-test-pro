 ...
 *
 *    $des = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt;

use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\BlockCipher;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\BadModeException;
...
class DES extends BlockCipher
{
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\DES::setupKey()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::block_size
     * @var int
     */
     ...
     * Key Length (in bytes)
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setKeyLength()
     * @var int
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::cipher_name_mcrypt
     * @var string
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::openssl_mode_names
     * @var array
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::cfb_init_len
     * @var int
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::isValidEngine()
     * @param int $engine
     * @return bool
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setKey()
     * @param string $key
     */
     ...
     * Encrypts a block
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::encryptBlock()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::encrypt()
     * @see self::encrypt()
     * @param string $in
     * @return string
     */
     ...
     * Decrypts a block
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::decryptBlock()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::decrypt()
     * @see self::decrypt()
     * @param string $in
     * @return string
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setupKey()
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setupInlineCrypt()
     */
