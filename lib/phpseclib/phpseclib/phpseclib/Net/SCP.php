 ...
 *
 *    $ssh = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH2('www.domain.tld');
 *    if (!$ssh->login('username', 'password')) {
 *        exit('bad login');
 *    }
 *    $scp = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SCP::_send()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1|\WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH2 $ssh
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
