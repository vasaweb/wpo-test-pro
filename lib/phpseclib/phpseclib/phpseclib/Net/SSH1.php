 ...
 *
 *    $ssh = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1('www.domain.tld');
...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net;

use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\DES;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Random;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\TripleDES;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Math\BigInteger;
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1::getSupportedAuthentications()
     * @access public
    */
    /**
    ...
    */
     ...
     * The Response Type
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1::_get_binary_packet()
     * @access private
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1::bitmap
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1::read()
    */
    /**
     ...
     * @param int $timeout
     * @param int $cipher
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1
     * @access public
     */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
            ...
            //    $this->crypto = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Crypt\Null();
            //    break;
     ...
     *
     * To execute further commands, a new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
