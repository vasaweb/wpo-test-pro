 ...
 *
 *    $ssh = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net\SSH2('www.domain.tld');
...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net;

use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Common\Functions\Strings;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Blowfish;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\ChaCha20;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\SymmetricKey;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\DH;
...
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\RC4;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Rijndael;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\RSA;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Twofish;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\ConnectionClosedException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\InsufficientSetupException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\InvalidPacketLengthException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\TimeoutException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\UnableToConnectException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\UnsupportedCurveException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net\SSH2::send_channel_packet()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net\SSH2::get_channel_packet()
     */
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
