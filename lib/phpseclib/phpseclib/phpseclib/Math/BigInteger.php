 ...
 * <code>
 * <?php
 *    $a = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger(2);
 *    $b = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math;

use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\BadConfigurationException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'WPO\\WC\\PDF_Invoices_Pro\\Vendor\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger('10');
     *    $b = new \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger('20');
     *
